...
const EDESIS_ASSIGNED_ONLY_MARKER = 'edesis-assigned-window-2026-08-30';
 ...
 * (sınıf/ogrenciIds eşleşmesi). sinavTuruId / açık katalog kurum geneli — eklenmez.
 * Liste: atanmış + süresi dolmamış (startDate/endDate).
 */
