...
## Hedef sunucu (Phoenix)

- Hostname: `app.phoenixdms.com`
- IPv4: `89.252.179.128`
- IPv6: `2a06:41c0:1:1::eac9:1e12`
- Public URL (HTTPS nginx): `https://app.phoenixdms.com`
- Kurulum: `whatsapp-gateway/deploy/phoenix-bootstrap.sh`
