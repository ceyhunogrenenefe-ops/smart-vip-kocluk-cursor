...
export const KIND_LABELS_TR = {
  ...
  class_absent_notice_staff: 'Devamsızlık (koç/öğretmen)',
  class_absent_parent_notice: 'Devamsızlık (veli, sabit şablon)',
  class_camera_off_notice: 'Kamera kapalı (veli)',
  class_camera_off_notice_staff: 'Kamera kapalı (koç/öğretmen)',
  attendance_status_update: 'Yoklama güncelleme (geç katıldı)',
  class_attendance_late_update: 'Yoklama güncelleme (geç katıldı)',
  coach_lesson_attendance_summary: 'Koç ders yoklama özeti',
  class_attendance_coach_summary: 'Koç ders yoklama özeti',
  attendance_coach_late_update: 'Koç geç katılım güncelleme',
  class_attendance_coach_late_delta: 'Koç geç katılım güncelleme',
...
export const TEMPLATE_TYPE_TO_LOG_KINDS = {
  ...
  class_absent_notice_1: ['class_absent_notice_1', 'class_absent_notice', 'class_absent_parent_notice', 'class_absent_notice_staff'],
  class_absent_notice: ['class_absent_notice', 'class_absent_notice_1'],
  class_absent_parent_notice: ['class_absent_parent_notice'],
  class_camera_off_notice: ['class_camera_off_notice', 'class_camera_off_notice_staff'],
  class_camera_off_notice_staff: ['class_camera_off_notice_staff'],
  class_absent_notice_staff: ['class_absent_notice_staff'],
  attendance_status_update: ['attendance_status_update', 'class_attendance_late_update'],
  coach_lesson_attendance_summary: ['coach_lesson_attendance_summary', 'class_attendance_coach_summary'],
  attendance_coach_late_update: ['attendance_coach_late_update', 'class_attendance_coach_late_delta'],
