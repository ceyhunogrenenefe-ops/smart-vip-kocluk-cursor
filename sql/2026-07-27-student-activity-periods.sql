-- Öğrenci aktiflik dönemleri (koçluk sistemi)
-- RUN IN SUPABASE SQL EDITOR (production)
-- Mevcut öğrenci/rapor verilerini silmez. Dönemi olmayan öğrenciler kodda varsayılan aktif kabul edilir;
-- migration sonrası coach_id olan her öğrenci için açık uçlu aktif dönem eklenir.
...
comment on table public.student_activity_periods is
  'Öğrenci aktif/pasif dönemleri; rapor tarihine göre aktiflik kontrolü için kullanılır.';

-- Mevcut koçlu öğrenciler: açık uçlu aktif dönem (geçiş varsayılanı)
